...
export abstract class Default {
    public static readonly APP_TITLE: string = 'Template Base TypeScript'
    public static readonly APP_DESCRIPTION: string = 'Base model for implementation of micro-services in typescript ' +
        'following principles of the clean architecture proposed by Robert C. Martin.'
    ...
    // MongoDB
    public static readonly MONGODB_URI: string = 'mongodb://127.0.0.1:27017/template-base-ts'
    public static readonly MONGODB_URI_TEST: string = 'mongodb://127.0.0.1:27017/template-base-ts-test'
